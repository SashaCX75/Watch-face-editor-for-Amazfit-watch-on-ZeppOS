...
namespace ControlLibrary
{
    public partial class UCtrl_EditableElements_Elm : UserControl
    {
        ...
        private void UCtrl_EditableElements_Elm_Load(object sender, EventArgs e)
        {
