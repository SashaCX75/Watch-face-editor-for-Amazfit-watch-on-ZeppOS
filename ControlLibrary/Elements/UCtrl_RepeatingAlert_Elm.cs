...
namespace ControlLibrary
{
    public partial class UCtrl_RepeatingAlert_Elm : UserControl
    {
        ...
        private void UCtrl_RepeatingAlert_Elm_Load(object sender, EventArgs e)
        {
