...
namespace ControlLibrary
{
    public partial class UCtrl_Switch_BG_Color_Elm : UserControl
    {
        ...
        /// <summary>Режим доступности элемента</summary>
        [Description("Режим доступности элемента")]
        public virtual bool EnableElement
        {
            get
            {
            ...
            set
            {
                ...
                button_ElementName.Enabled = enable_element;
            }
        }
        ...
        private void UCtrl_Image_Elm_Load(object sender, EventArgs e)
        {
